...
public class OceaniaViewActivity extends AppCompatActivity {

    Button btnVolverContinentes;
    Button verPaisesOceania;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oceania_view);
        ...
        btnVolverContinentes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OceaniaViewActivity.this, ContinentesActivity.class);
                startActivity(intent);

            }
        });

        ch1 = (CheckBox) findViewById(R.id.cbAustralia);
        ch2 = (CheckBox) findViewById(R.id.cbPalao);
        ch3 = (CheckBox) findViewById(R.id.cbSamoa);
        verPaisesOceania = findViewById(R.id.btnVerPaises);
        verPaisesOceania.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(!option1Seleccionada && !option2Seleccionada && !option3Seleccionada ){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(OceaniaViewActivity.this);
                    ...
                    Intent intent = new Intent(OceaniaViewActivity.this, OceaniaContentActivity.class);
