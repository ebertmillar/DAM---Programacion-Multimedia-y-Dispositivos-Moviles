...
public class AmericaViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_america_view);
        ...
        btnVolverContinentes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AmericaViewActivity.this, ContinentesActivity.class);
                startActivity(intent);

            }
        });

        ch1 = (CheckBox) findViewById(R.id.cbArgentina);
        ch2 = (CheckBox) findViewById(R.id.cbCanada);
        ch3 = (CheckBox) findViewById(R.id.cbPeru);
        verPaisesAfrica = findViewById(R.id.btnVerPaisesAmerica);
        verPaisesAfrica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!option1Seleccionada && !option2Seleccionada && !option3Seleccionada ){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(AmericaViewActivity.this);
                    ...
                    Intent intent = new Intent(AmericaViewActivity.this, AmericaContentActivity.class);
